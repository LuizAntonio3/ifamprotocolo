...
import alunoForm from './alunoform.js'
import _aluno from '../../models/aluno'
...
class Items extends Component {
    ...
    componentDidMount() {
        _aluno.listAll(this.handleFetchItemsResponse)
    }
    componentWillMount = () => {
        this.tableHeaders = [
    ...
    handleItemDeleteClick(event) {
        ...
        _aluno.delete(event.target.id, this.handleDeleteItemResponse)
    }
