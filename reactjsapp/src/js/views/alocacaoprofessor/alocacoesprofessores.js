...
import alocacaoprofessorForm from './alocacaoprofessorform.js'
import _alocacaoprofessor from '../../models/alocacao_professor'
...
class Items extends Component {
    ...
    componentDidMount() {
        _alocacaoprofessor.listAll(this.handleFetchItemsResponse)
    }
    componentWillMount = () => {
        this.tableHeaders = [
    ...
    handleItemDeleteClick(event) {
        ...
        _alocacaoprofessor.delete(event.target.id, this.handleDeleteItemResponse)
    }
