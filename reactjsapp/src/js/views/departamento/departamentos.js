...
import _departamento from '../../models/departamento'
...
class Items extends Component {
    ...
    componentDidMount() {
        _departamento.listAll(this.handleFetchItemsResponse)
    }
    componentWillMount = () => {
        this.tableHeaders = [
                        {id:0, name:"ID", column: "id" },
                        {id:1, name:"Nome", column: "nome"},
                        {id:2, name:"Responsavel", column: "id_responsavel_departamento"}
                        ];
    }
    ...
    handleItemDeleteClick(event) {
        ...
        _departamento.delete(event.target.id, this.handleDeleteItemResponse)
    }
