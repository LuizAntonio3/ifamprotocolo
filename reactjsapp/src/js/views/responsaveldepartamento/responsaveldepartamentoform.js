...
class ResponsavelDepartamentoForm extends Component {
    ...
    handleApiCall (res) {
        ...
        if (res.success) {
            alert('Responsável criada com sucesso');
            this.props.onSaved();  
        } else {
            alert('Não foi possível realizar a responsável do departamento');
        }
    }
    handleSubmit(event){
        ...
        _responsavel_departamento.create(data, this.handleApiCall)
